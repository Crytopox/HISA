        ...
        private void StartServer()
        {
            ...
            try
            {
                ...
                while (!serverDone)
                {
                    ...
                    EVEData.EveManager.Instance.HandleEveAuthHISAUri(request.Url, challengeCode);

                    // Obtain a response object.
                    HttpListenerResponse response = context.Response;
                    // Construct a response.
                    //                    string responseString = $"<HTML><BODY>HISA Character Added.. close logon window when done or click <a href=\"{esiLogonURL}\"> here </a> to add another character</BODY></HTML>";
                    string responseString = $"<HTML><HEAD title=\"HISA Auth\"><meta http-equiv=\"refresh\" content=\"1;url={esiLogonURL}\"></HEAD><BODY>HISA Character Added..</HTML>";
